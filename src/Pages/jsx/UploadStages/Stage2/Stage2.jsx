    ...
    <div className={`${u2css[`panel`]}`}>
      {!readUp && (
        <div className={u2css[`instructions-box`]}>
          <p>
            Xin hãy nộp một file chứa bài nghiên cứu của bạn (.docx, .pdf, etc.)
          </p>
      ...
      {!readDown && (
        <div className={u2css[`instructions-box-down`]}>
          <p>
            Cho những người tham gia PIISE, hãy điền tên file theo quy định của
            cuộc thi:{" "}
            <span style={{ "font-weight": "900" }}>
              (Bảng tham gia)_(Lĩnh vực)_(MSHS đại diện, không dấu)
            </span>
          </p>
          <p style={{ "font-style": "italic" }}>
            E.g: "<span style={{ "font-weight": "800" }}>A_A1_210422</span>", "
            <span style={{ "font-weight": "800" }}>B1_A4_210622</span>", "
            <span style={{ "font-weight": "800" }}>C2_B5_220901</span>", hoặc "
            <span style={{ "font-weight": "800" }}>B2_B1_220901_1</span>" và "
            <span style={{ "font-weight": "800" }}>B2_B1_220901_2</span>" trong
            trường hợp nhóm bạn đăng ký 2-3 ý tưởng cùng bảng báo cáo và lĩnh
            vực{" "}
          </p>
          <div className={u2css[`understood`]}>
