...
function Navbar() {
  ...
  return (
    <div>
      {/* the navbar itself*/}
      <div
        className={`${navbarcss["nav-wrap"]} ${show ? navbarcss.shown : navbarcss.hidden}`}
      >
        <nav className={navbarcss["navbar"]}>
          ...
          <div className={navbarcss["right-container"]}>
            <div
              className={`${navbarcss["register-button-wrap"]} ${auth.user ? navbarcss["hide"] : navbarcss["show"]}`}
            >
              <Link className={navbarcss["register-button-link"]} to="/signup">
                <div className={navbarcss["register-button"]}>Register</div>
              </Link>
            </div>
            <div
              className={`${navbarcss["login-button-wrap"]} ${auth.user ? navbarcss["hide"] : navbarcss["show"]}`}
            >
              <Link className={navbarcss["login-button-link"]} to="/login">
                <div className={navbarcss["login-button"]}>
                  Log in {loginIcon}
                </div>
              </Link>
            </div>
            <div
              className={`${navbarcss["username-box-wrap"]} ${auth.user ? navbarcss["show"] : navbarcss["hide"]}`}
            >
              <div className={navbarcss["username-box"]} onClick={handleUDD}>
                {auth.user ? `${auth.user.first_name}` : "none"} {downIcon}
              </div>
            </div>
          </div>
        </nav>
        ...
        <div
          className={`${navbarcss["nav-menu"]} ${click ? navbarcss["active"] : navbarcss["inactive"]}`}
        >
        ...
        <ul
          className={`${navbarcss.udd} ${UDDA ? navbarcss.activeudda : navbarcss.inactiveudda}`}
        >
          {/* <li className={`${navbarcss.uddi} ${navbarcss['edit-profile']}`}><span className={navbarcss.uddic}>{userIcon}</span>Edit Profile</li> */}
          <li
            className={`${navbarcss.uddi} ${navbarcss["logout"]}`}
            onClick={logOut}
          >
            <span className={navbarcss.uddic}> {logoutIcon}</span>Log out
          </li>
        </ul>
      </div>
