    ...
    <div className={footercss["footer"]}>
      <div className={footercss["upper-footer"]}>
        <div className={footercss["main-link-wrap"]}>
          ...
          <Link className={footercss["main-link"]} to="/upload">
            Upload your paper
          </Link>
          <Link className={footercss["main-link"]} to="/about#terms-of-use">
            Terms & Conditions
          </Link>
          ...
          <Link className={footercss["main-link"]} to="/about">
            About us
          </Link>
        </div>
        <div className={footercss["follow-contact"]}>
          <div className={footercss["follow-wrap"]}>
            ...
            <div className={footercss["follow-icons"]}>
              <a href="https://www.facebook.com/people/InitiaRe/100092825321496/">
                {facebookIcon}
              </a>
          ...
          <div className={footercss["contact-wrap"]}>
            ...
            <div className={footercss["contact-email"]}>
              initiare.view@gmail.com
            </div>
          </div>
        </div>
        <div className={footercss["disclaimer-wrap"]}>
          <span className={footercss["disclaimer-title"]}>Disclaimer: </span>
          <span className={footercss["disclaimer-text"]}>
            The information on this site is not intended or implied to be a
            substitute for professional advice. InitiaRe's resources are for
