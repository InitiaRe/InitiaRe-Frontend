...
function Login() {
  ...
  const handleChange = (event) => {
    ...
    setState({
      ...state,
      [target.name]:
        target.type === "checkbox" ? !state[target.name] : target.value,
    });
  };
    ...
    <div className={logincss[`sign-in-wrapper`]}>
      <div className={logincss["sign-in-panel"]}>
        <div className={logincss["big-text-wrap"]}>
          <div className={logincss["big-text"]}>
            Log in to <span style={{ color: "var(--secondary)" }}>Initia</span>
            <span style={{ color: "var(--primary)" }}>Re</span>
          </div>
          <div className={logincss["close-icon"]} onClick={() => navigate(-1)}>
        ...
        >
          ...
          <div className={logincss["password-wrap"]}>
            <div className={logincss["info-text-wrap"]}>
              ...
              <div className={logincss["show-button"]} onClick={PVT}>
                show
              </div>
            </div>
            <input
          ...
          <div className={`${logincss["memory-foam"]}`}>
            <div
              ...
              className={`${logincss["remember-me-wrap"]}`}
            >
              <div
                className={`${logincss["remember-me-checkbox"]} ${remember ? logincss.checked : logincss.unchecked}`}
              >
                <span>
                  <FontAwesomeIcon icon={faCheck} />
                </span>
              </div>
              <div className={`${logincss["remember-me-text"]}`}>
                Remember me
              </div>
            </div>
            <div
              className={`${logincss["forgot"]} ${logincss["clickable-text-small"]}`}
            >
              Forgot password?
            </div>
          </div>
          ...
          {wrong && (
            <div className={logincss["wrong-message"]}>
        ...
        <div className={logincss["register-wrap"]}>
          ...
          <div className={logincss["reg-link"]}>
