const about_text = [
    ...
    },
    {
        ...
        answer: `We are InitiaRe, your gateway to a world of research excellence! Our mission is to revolutionize the academic landscape by providing an accessible and dynamic platform designed specifically for students. With InitiaRe, you can unlock the power of professional research, exchange ideas, and discover reliable sources effortlessly. Whether you're an aspiring author looking to publish your work or a curious mind seeking fresh inspiration, our versatile platform has you covered. InitiaRe, derived from the Latin word for "initiate," serves as your starting point on the exciting journey of research and knowledge pursuit. Join our research family of like-minded individuals, and together, let's unleash the transformative power of research for students nationwide. Embrace InitiaRe and initiate your research revolution today!`,
...
export { about_text, about_navLinks };